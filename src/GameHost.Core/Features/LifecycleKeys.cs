...
public static class LifecycleKeys
{
    ...
    public static class Queries
    {
        ...
        /// </list>
        /// </remarks>
        public const string GET_RAW_GAME_INFO = $"{BaseInfo.AssemblyName}.{nameof(LifecycleKeys)}.{nameof(Events)}.{nameof(Queries)}.{nameof(GET_RAW_GAME_INFO)}";
    ...
    public static class Events
    {
        ...
        /// </summary>
        public const string GAMEINFO_STATE_CHANGED = $"{BaseInfo.AssemblyName}.{nameof(LifecycleKeys)}.{nameof(Events)}.{nameof(GAMEINFO_STATE_CHANGED)}";
        ...
        public static class ServerControl
        {
            ...
            /// </summary>
            public const string TRANSITION_TIMEDOUT = $"{BaseInfo.AssemblyName}.{nameof(LifecycleKeys)}.{nameof(Events)}.{nameof(ServerControl)}.{nameof(TRANSITION_TIMEDOUT)}";
            /// <summary>
            /// This occurs when stop/start/restart has complete and transited to expect state stopped -> started, started -> stopped.
            /// </summary>
            public const string TRANSITION_COMPLETED = $"{BaseInfo.AssemblyName}.{nameof(LifecycleKeys)}.{nameof(Events)}.{nameof(ServerControl)}.{nameof(TRANSITION_COMPLETED)}";
        }
        public static class Scheduled
        {
            ...
            /// </list>
            /// </remarks>
            public const string GAME_SERVER_INFO_CHECK = $"{BaseInfo.AssemblyName}.{nameof(LifecycleKeys)}.{nameof(Events)}.{nameof(Scheduled)}.{nameof(GAME_SERVER_INFO_CHECK)}";
