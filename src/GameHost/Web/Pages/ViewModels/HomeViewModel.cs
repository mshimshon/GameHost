...
public class HomeViewModel : WidgetViewModelBase, IHomeViewModel
{
    ...
    public bool IsModSupported => !ModListState.IsFeatureInfoLoading && ModListState.FeatureInfo != default && ModListState.FeatureInfo.IsEnabled;
